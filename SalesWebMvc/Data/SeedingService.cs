...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r5 = new SalesRecord(new DateTime(2022, 03, 24), 3300.00, SaleStatus.Pending, s5);
            ...
            SalesRecord r9 = new SalesRecord(new DateTime(2022, 04, 22), 2300.00, SaleStatus.Pending, s3);
            SalesRecord r10 = new SalesRecord(new DateTime(2022, 02, 15), 2300.00, SaleStatus.Pending, s4);
            SalesRecord r11 = new SalesRecord(new DateTime(2022, 10, 13), 2300.00, SaleStatus.Pending, s5);
            SalesRecord r12 = new SalesRecord(new DateTime(2022, 09, 12), 2300.00, SaleStatus.Pending, s6);
            SalesRecord r13 = new SalesRecord(new DateTime(2022, 10, 20), 2300.00, SaleStatus.Pending, s1);
            SalesRecord r14 = new SalesRecord(new DateTime(2022, 09, 12), 2300.00, SaleStatus.Pending, s2);
            SalesRecord r15 = new SalesRecord(new DateTime(2022, 12, 01), 2300.00, SaleStatus.Pending, s3);
            SalesRecord r16 = new SalesRecord(new DateTime(2022, 11, 1), 2300.00, SaleStatus.Pending, s4);
            SalesRecord r17 = new SalesRecord(new DateTime(2022, 11, 04), 2300.00, SaleStatus.Pending, s5);
            SalesRecord r18 = new SalesRecord(new DateTime(2022, 04, 08), 2300.00, SaleStatus.Pending, s6);
            SalesRecord r19 = new SalesRecord(new DateTime(2022, 04, 10), 2300.00, SaleStatus.Pending, s1);
            SalesRecord r20 = new SalesRecord(new DateTime(2022, 05, 02), 2300.00, SaleStatus.Pending, s2);
            ...
            SalesRecord r24 = new SalesRecord(new DateTime(2022, 07, 07), 2300.00, SaleStatus.Pending, s6);
            ...
            SalesRecord r27 = new SalesRecord(new DateTime(2022, 08, 23), 2300.00, SaleStatus.Pending, s3);
            SalesRecord r28 = new SalesRecord(new DateTime(2022, 09, 30), 2300.00, SaleStatus.Pending, s4);
            SalesRecord r29 = new SalesRecord(new DateTime(2022, 06, 22), 2300.00, SaleStatus.Pending, s5);
            SalesRecord r30 = new SalesRecord(new DateTime(2022, 07, 27), 2300.00, SaleStatus.Pending, s6);
